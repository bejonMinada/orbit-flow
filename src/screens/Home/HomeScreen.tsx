    ...
    >
      ...
      <View style={styles.statsGrid}>
        <View style={[styles.statCard, styles.primaryCard, { backgroundColor: netCardColor }]}>
          ...
          <Text style={styles.ledgerCount}>{chartData.netBalance === 0 ? 'Zero balance' : `${ledgers.length} Cash Ledger${ledgers.length !== 1 ? 's' : ''}`}</Text>
        </View>
        <View style={styles.statMiniRow}>
          ...
          <View style={[styles.statCard, styles.statCardCompact, isDark && { backgroundColor: darkSurface }]}>
            <Text style={[styles.statLabel, isDark && { color: darkMuted }]}>Pending</Text>
      ...
      <View style={[styles.chartCard, isDark && { backgroundColor: darkSurface }]}>
        <View style={styles.chartAmounts}>
          <View>
            <Text style={styles.chartAmountLabel}>Net Balance</Text>
            <Text
              style={[
                styles.chartAmount,
...
const styles = StyleSheet.create({
  ...
  statMiniRow: { flexDirection: 'row', gap: Spacing.sm },
  statCard: {
    backgroundColor: Colors.surface,
